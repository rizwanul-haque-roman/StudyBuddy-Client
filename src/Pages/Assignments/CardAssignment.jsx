...
const CardAssignment = ({ assignment }) => {
  ...
  return (
    <div className="bg-white rounded-2xl hover:transform hover:scale-[1.05] hover:transition hover:duration-300  hover:drop-shadow-xl transition duration-300 ease-out border-2">
