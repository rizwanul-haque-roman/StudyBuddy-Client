          ...
          <div className="hero justify-between">
            <div className="flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="lg:w-1/2">
                ...
                <div className="rounded-xl p-6 bg-[#F7F7F7] hover:bg-[#fff] my-6 flex items-center justify-center hover:scale-110 transition duration-300 ease-out hover:transition hover:duration-300 hover:ease-in-out hover:drop-shadow-2xl">
